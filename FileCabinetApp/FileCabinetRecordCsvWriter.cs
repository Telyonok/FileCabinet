...
namespace FileCabinetApp
{
    ...
    internal class FileCabinetRecordCsvWriter
    {
        ...
        {
            this.textWriter.WriteLine($"{record.Id}, {record.FirstName}, {record.LastName}, {record.Sex}, {record.Weight}, {record.Height}, {record.DateOfBirth.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture)}");
        }
